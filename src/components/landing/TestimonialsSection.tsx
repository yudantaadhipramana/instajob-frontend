    ...
    0: [
      {
        ...
        company: 'Google',
        quote: t('quote1.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Rini&backgroundColor=e2e8f0',
      },
      {
        name: 'Budi Hartono',
        ...
        company: 'Shopee',
        quote: t('quote2.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=BudiH&backgroundColor=e2e8f0',
      },
      {
        name: 'Maya Wijaya',
        ...
        company: 'GoTo',
        quote: t('quote3.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=MayaW&backgroundColor=e2e8f0',
      },
      {
        name: 'Dian Permata',
        ...
        company: 'Tokopedia',
        quote: t('quote4.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=DianP&backgroundColor=e2e8f0',
      },
    ],
    1: [
      {
        ...
        company: 'BCA',
        quote: t('quote5.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=AgusP&backgroundColor=e2e8f0',
      },
      {
        name: 'Sari Dewi',
        ...
        company: 'Telkom',
        quote: t('quote6.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=SariD&backgroundColor=e2e8f0',
      },
    ],
    2: [
      {
        ...
        company: 'Microsoft',
        quote: t('quote7.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=DimasA&backgroundColor=e2e8f0',
      },
      {
        name: 'Ratna Kusuma',
        ...
        company: 'Gojek',
        quote: t('quote8.text'),
        avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=RatnaK&backgroundColor=e2e8f0',
      },
    ],
  };

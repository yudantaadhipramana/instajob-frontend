        ...
        {profileOpen && (
          <div style={{ position: 'absolute', top: '44px', right: 0, background: '#fff', borderRadius: '12px', border: '1px solid #E5E7EB', boxShadow: '0 8px 24px rgba(0,0,0,0.1)', zIndex: 300, minWidth: '200px', overflow: 'hidden' }}>
            ...
            <div style={{ padding: '4px 0' }}>
              {[
                { href: '/affiliate/profile', svg: <><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></>, label: 'Profile' },
                { href: '/affiliate/withdrawal', svg: <path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>, label: 'Withdrawal' },
                { href: '/affiliate/referrals', svg: <><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></>, label: 'Referrals' },
                { href: '/affiliate/add-class', svg: <><path d="M12 5v14M5 12h14"/></>, label: 'Add Class' },
                { href: '/affiliate/settings', svg: <><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m2.12 2.12l4.24 4.24M1 12h6m6 0h6m-16.78 7.78l4.24-4.24m2.12-2.12l4.24-4.24"/></>, label: 'Settings' },
              ].map(item => (

            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    padding: '12px 24px',
                    background: stats.isActive ? 'linear-gradient(135deg, #10B981, #059669)' : '#E2E8F0',
                    color: stats.isActive ? '#fff' : '#64748B',
                    border: 'none',
                    borderRadius: '8px',
                    fontWeight: '600',
                    cursor: 'pointer',
                ...
                >
                  {stats.isActive ? '⏸ Disable Auto-Apply' : '▶ Enable Auto-Apply'}
                </button>
              </div>

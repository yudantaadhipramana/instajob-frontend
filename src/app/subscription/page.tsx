  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <header style={{
        ...
        <Link href="/dashboard" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--color-primary)', fontWeight: '600', fontSize: '14px', textDecoration: 'none' }}>
          <ArrowLeft size={16} />
          {t('nav.dashboard')}
        </Link>
        <Logo />
      ...
      {/* Pricing Section — Clone dari PricingSection.tsx */}
      <section
        style={{
          padding: '100px 48px',
          background: '#FFFFFF',
